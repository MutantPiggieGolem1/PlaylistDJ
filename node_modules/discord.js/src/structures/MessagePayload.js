  ...
  makeContent() {
    ...
    if (this.options.content === null) {
      ...
      if (this.options.content instanceof Object) {
        console.log("Verifying Content: "+JSON.stringify(this.options.content))
        content = Util.verifyString(this.options.content.content, RangeError, 'MESSAGE_CONTENT_TYPE', false);
        return content;
      }
